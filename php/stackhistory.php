...
$sql = "SELECT parent_id FROM story_reference_web WHERE child_id='$id' AND child_version=$v";
...
if ($result->num_rows == 1) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // Get grandparent.
        $sql_grandparent = "SELECT parent_id FROM story_reference_web WHERE child_id='$parent_id'";
