...
INSERT INTO WoH_content VALUES ("WLHSQY", 2, "Farshtey", "es", NULL, NULL, "LA LEYENDA DE MATA NUI", "La leyenda comienza…", 1, "<span class='anchors' id='p1'><a class='anchor' href='#p1'>1</a><p>En un tiempo anterior al tiempo, el Gran Espíritu descendió del cielo, trayéndonos con él, a nosotros, los Matoran, hasta este paraíso. Nos encontrábamos desunidos y sin designio, así que el Gran Espíritu nos iluminó con las tres virtudes: Unidad, Deber y Destina. Nosotros abrazamos estos dones y agradecidos dimos a nuestra isla el nombre de Mata Nui pues así se llama el Gran Espíritu. Pero nuestra felicidad no duraría ya que el hermano de Mata Nui, Makuta, sintió envidia de esos honores y lo traicionó lanzando un conjuro sabre Mata Nui que quedó sumido en un profundo sueño. El poder de Makuta se adueñó de la tierra, los campos se hicieron yermos, la luz del sol se apagó y los antiguos valores fueron olvidados.</p></span><span class='anchors' id='p2'><a class='anchor' href='#p2'>2</a><p>Sin embargo, atisbábamos un hilo de esperanza. Según las leyendas, seis héroes poderosos, los Toa, llegarían para liberar a Mata Nui. El tiempo revelaría que no se trataba de simples mitos, ya que los Toa aparecerían en las orillas de la isla. Llegaron faltos de recuerdos, sin conocerse entre ellos, pero prometieron defender a Mata Nui y a su gente contra las sombras. Tahu, Toa del Fuego. Onua, Toa de la Tierra. Gali, Toa del Agua. Lewa, Toa del Aire. Pohatu, Toa de la Piedra. Y Kopaka, Toa del Hielo. Grandes guerreros con un inmenso poder que emanaba de los elementos. Seis héroes con un único destino: derrotar a Makuta y salvar a Mata Nui.</p></span><span class='anchors' id='p3'><a class='anchor' href='#p3'>3</a><p>Esta es su historia.</p></span>", 500);

INSERT INTO WoH_content VALUES ("WLHSQY", 2, "Farshtey", "en", NULL, NULL, "The Legend of Mata Nui", "The legend begins…", 1, "<span class='anchors' id='p1'><a class='anchor' href='#p1'>1</a><p>In the time before time, the Great Spirit descended from the heavens, carrying us, the ones called the Matoran, to this island paradise. We were separate and without purpose, so the Great Spirit blessed us with three virtues: unity, duty, and destiny. We embraced these gifts and, in gratitude, we named our island home Mata Nui, after the Great Spirit himself.</p></span><span class='anchors' id='p2'><a class='anchor' href='#p2'>2</a><p>But our happiness was not to last. Mata Nui’s brother, Makuta, was jealous of these hon­ors and betrayed him. Makuta cast a spell over Mata Nui, who fell into a deep slumber. Makuta’s power dominated the land, as fields withered away, sunlight grew cold, and ancient values were forgotten.</p></span><span class='anchors' id='p3'><a class='anchor' href='#p3'>3</a><p>Still, all hope was not lost. Legends told of six mighty heroes, the Toa, who would arrive to save Mata Nui. Time would reveal that these were not simply myths — for the Toa did appear on the shores of the island. They arrived with no memory, no knowledge of one another — but they pledged to defend Mata Nui and its people against the darkness. Tahu, Toa of Fire. <a class='modalbtn'>Onua</a>, Toa of Earth. Gali, Toa of Water. Lewa, Toa of Air. Po­hatu, Toa of Stone. And Kopaka, Toa of Ice. Great warriors with great power, drawn from the very elements themselves. Together, they were six he­roes with one destiny: to defeat Makuta and save Mata Nui.</p></span><span class='anchors' id='p4'><a class='anchor' href='#p4'>4</a><p>This is their story.</p></span>", 500);

INSERT INTO woh_web VALUES ("GNO2P6", 1, "WLHSQY", 2);